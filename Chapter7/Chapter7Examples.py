...
>>> ('TTA'+'G'*3).count('T')
2
>>> ('What is the name of that country').find('t')
3
>>> ('What is the name of that country').find(' ')
4
>>> ('What is the name of that country').find('s',4)
6
>>> ('What is the name of that country').find('a',4)
13
>>> ('What is the name of that country').find('a',14,-1)
22
>>> 'species'.startswitch('a')
Traceback (most recent call last):
